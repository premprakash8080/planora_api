...
//get my tasks
router.get("/get-my-tasks", getMyTasks);
//get my tasks calendar view
router.get("/get-my-tasks-calendar-view", getMyTasksCalendarViewData);
//get my tasks board view
router.get("/get-my-tasks-board-view", getMyTasksBoardViewData);
